...
export const carSchema = z.object({
    ...
    year: z.number({ message: "Year must be a number" }).int({ message: "Year must be an integer" }).min(1990, { message: "Year must be 1990 or later, and no later than 2026" }).max(2026, { message: "Year cannot be later than 2026, and cannot be earlier than 1990" })
